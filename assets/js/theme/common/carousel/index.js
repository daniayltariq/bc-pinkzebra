...
export default function (context) {
    $('[data-slick]').each((idx, carousel) => {
        ...
        initScentflirtProductLabels(context, '#tab-related');
        initScentflirtProductLabels(context, '#tab-similar');
        initScentflirtProductLabels(context, '#featured-products');

        addAvailabilityToProductsCards('#tab-related', 'CAROUSEL');
        addAvailabilityToProductsCards('#tab-similar', 'CAROUSEL');
        addAvailabilityToProductsCards('#featured-products', 'CAROUSEL');
    });
}
