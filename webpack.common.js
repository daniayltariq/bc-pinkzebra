...
module.exports = {
    ...
    resolve: {
        ...
        alias: {
            ...
            '@host-a-party': path.resolve(__dirname, 'assets/js/theme/HostAPartyApp/'),
            '@scentflirt': path.resolve(__dirname, 'assets/js/theme/ScentflirtApp/'),
            '@shared': path.resolve(__dirname, 'assets/js/theme/shared-components/'),
        },
    },
};
